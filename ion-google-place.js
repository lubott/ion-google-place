    ...
    angular.module('ion-google-place', [])
        ...
        function ionGooglePlace($ionicTemplateLoader, $ionicBackdrop, $ionicPlatform, $q, $timeout, $rootScope, $document) {
            var directive = {
                require: '?ngModel',
                restrict: 'E',
                templateUrl: 'lib/ion-google-place/ion-google-place-input.tmpl.html',
                replace: true,
                scope: {
                    ngModel: '=?',
                    geocodeOptions: '='
            ...
            function link(scope, element, attrs, ngModel) {
                ...
                // TODO Possibly replace Geocoder with Places
                ...
                popupPromise.then(function(el){
                    ...
                    // Watch the model for a change (on edit, when its manually added)
                    // to fill up the input field
                    var startUpWatcher = scope.$watch('ngModel', function() {
                        if (scope.ngModel) {
                            element.val(scope.ngModel.formatted_address);
                            // Call itself, to clear the watch
                            startUpWatcher();
                        }
                    });
